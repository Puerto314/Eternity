...
public class MujerDTO extends Usuario implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 147040893783478332L;
	...
	public MujerDTO(String edad, float estatura, String fotoPerfil, int meGusta, boolean disponibilidad, String lugar,
	...
	public MujerDTO(String nombre, String alias, long cedula, String correo, String contrasenya,
			...
			boolean disponibilidad, String lugar, boolean sexo, boolean estaDivorciada) {
	...
	public MujerDTO(String nombre, String alias, long cedula, String correo, String contrasenya,
			String codigoVerificacion, boolean estaDivorciada) {
